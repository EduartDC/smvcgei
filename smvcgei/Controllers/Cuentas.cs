...
namespace smvcgei.Controllers
{
    ...
    public class Cuentas : Controller
    {
        ...
        public Cuentas(IdentityContext context, UserManager<CustomIdentityUser> userManager, SignInManager<CustomIdentityUser> signInManager)
        {
            _context = context;
